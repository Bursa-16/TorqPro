...
feature/faz-2.9.13-question-bank-import-export-hardening
...
/api/joints/{joint_id}/revisions

GET

/api/joints/revisions/{revision_id}

POST

/api/joints/revisions/{revision_id}/submit

POST

/api/joints/revisions/{revision_id}/approve

POST

/api/joints/revisions/{revision_id}/reject
...
feature/faz-2.8.17-joint-revision-http-api

Feature Commit

4ddb925 (final functional commit — the documentation stage adds only version/documentation metadata in the commit immediately following)
...
Torque Study UI/UX Messaging and CI Stage-Boundary Reliability
...
Question Bank Retrieval Filtering and Read API
...
Question Bank Lifecycle / Audit Workflow

✅ Completed

Phase 2.9.5

Question Bank Search, Tagging & Difficulty

✅ Completed

Phase 2.9.6

Question Bank Create + Lifecycle API
...
Question Bank Import/Export Workflow

✅ Completed

Phase 2.9.10

Question Bank Statistics API
...
Question Bank Statistics Trend History
...
Question Bank Hybrid Persistence Foundation
