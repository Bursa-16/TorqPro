...
def test_version_file_exists_and_is_2_8_17():
    assert VERSION_FILE.exists()
    assert VERSION_FILE.read_text(encoding="utf-8").strip() == "2.8.17"
...
def test_backend_app_version_matches_version_file():
    ...
    assert app_module.APP_VERSION == "2.8.17"
